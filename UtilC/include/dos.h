...
typedef struct {
    ...
    char filename[13];
    uint8_t attributes;
    uint8_t timeOfModification[2];
    uint8_t dateOfModification[2];
...
typedef struct {
    uint8_t driveStatus;
    uint8_t driverSlotNumber;
    uint8_t driverSegmentNumber;
    uint8_t relativeDriveNumber;
    uint8_t deviceIndex;
    uint8_t logicalUnitNumber;
    uint32_t firstSectorNumber;
    uint8_t reserved[64 - 10];
} driveLetterInfo;
...
typedef struct {
    uint16_t fatSectorNumber;
    uint16_t entryOffsetInFatSector;
    uint32_t dataSectorNumber;
    uint16_t fatEntryValue;
